...
add_action( 'after_setup_theme', 'NirTheme_block_editor_setup' );

if ( ! function_exists( 'NirTheme_block_editor_setup' ) ) {
	 ...
	 * @since 1.0.0
	 */
	function NirTheme_block_editor_setup() {
		...
		$color_palette = NirTheme_generate_color_palette();
		if ( $color_palette ) {
...
if ( ! function_exists( 'NirTheme_generate_color_palette' ) ) {
	/**
	 ...
	 * @return array
	 */
	function NirTheme_generate_color_palette() {
		$color_palette = array();
		 ...
		 */
		return apply_filters( 'NirTheme_theme_editor_color_palette', $color_palette );
	}
}
