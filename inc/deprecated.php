...
if ( ! function_exists( 'NirTheme_theme_slug_sanitize_select' ) ) {
	/**
	 * Sanitize select.
	 *
	 * @deprecated 1.2.0 Use NirTheme_customize_sanitize_select()
	 * @see NirTheme_customize_sanitize_select()
	 *
	 * @since 0.6.11
	 *
	 ...
	 */
	function NirTheme_theme_slug_sanitize_select( $input, $setting ) {
		_deprecated_function( __FUNCTION__, '1.2.0', 'NirTheme_customize_sanitize_select' );
		return NirTheme_customize_sanitize_select( $input, $setting );
	}
}
...
if ( ! function_exists( 'NirTheme_adjust_body_class' ) ) {
	 ...
	 */
	function NirTheme_adjust_body_class( $classes ) {
		_deprecated_function( 'NirTheme_adjust_body_class', '0.9.4' );
		return $classes;
	}
}

if ( ! function_exists( 'NirTheme_slbd_count_widgets' ) ) {
	/**
	 ...
	 * @deprecated 0.8.9
	 */
	function NirTheme_slbd_count_widgets( $sidebar_id ) {

		_deprecated_function( 'NirTheme_slbd_count_widgets', '0.8.9', 'NirTheme_widget_classes' );
