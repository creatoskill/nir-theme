...
if ( ! function_exists( 'NirTheme_pagination' ) ) {
	/**
	 ...
	 */
	function NirTheme_pagination( $args = array(), $class = 'pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => _x( '&laquo;', 'previous set of posts', 'NirTheme' ),
				'next_text'          => _x( '&raquo;', 'next set of posts', 'NirTheme' ),
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'NirTheme' ),
			)
		);
