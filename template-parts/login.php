...
function login_header( $title = 'Log In', $message = '', $wp_error = null ) {
	...
	$login_header_text = empty( $login_header_title ) ? __( 'Powered by Nirbhai' ) : $login_header_title;
...
switch ( $action ) {
	...
	default:
		...
		<form name="loginform" class="login-form-cs" id="loginform" action="<?php echo esc_url( site_url( 'wp-login.php', 'login_post' ) ); ?>" method="post">
			<h1><a href="<?php echo esc_url( $login_header_url ); ?>">NirBhai Sidhu</a></h1>
			<div class="custom-form-settings">
			<p>
				<label for="user_login"><?php _e( 'Username or Email Address' ); ?></label>
			...
			<div class="user-pass-wrap">
				...
				<div class="wp-pwd">
					...
					<button type="button" class="button btn-custom-css wp-hide-pw hide-if-no-js" data-toggle="0" aria-label="<?php esc_attr_e( 'Show password' ); ?>">
			...
			?>
			<p class="cs-submit submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-custom-cs button-large" value="<?php esc_attr_e( 'Log In' ); ?>" />
				<?php
